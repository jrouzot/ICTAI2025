...
public:
     ...
     * \param c - The CmdLine object the output is generatedTmp for.
     */
...
inline void ZshCompletionOutput::failure(
    CmdLineInterface& _cmd, ArgException& e)
{
...
inline void ZshCompletionOutput::printArg(Arg* a)
{
    ...
    std::cout << a->getName() << ':';
    std::map<std::string, std::string>::iterator compArg
        = common.find(a->getName());
...
inline std::string ZshCompletionOutput::getMutexList(
    CmdLineInterface& _cmd, Arg* a)
{
